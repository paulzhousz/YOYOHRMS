...
namespace YOYO.HRMS.Core.Localization
{
    ...
    /// </summary>
    public sealed class ValidationAttributeAdapterFactory
    {
        ...
        public void Map<T>(IValidationAttributeAdapterFactory factory) where T : ValidationAttribute
        {
